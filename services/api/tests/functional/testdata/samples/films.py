...
films_sample = [
    ...
    },
    {
        ...
        "writers_names": ["Jonathan Hales", "George Lucas"],
        "directors": [
            {"id": "a5a8f573-3cee-4ccc-8a2b-91cb9f55250a", "name": "George Lucas"}
        ],
        "actors": [
            ...
            {"id": "69b02c62-a329-414d-83c6-ca54be34de24", "name": "Ewan McGregor"},
            {"id": "c777f646-dae0-466f-867a-bc535a0b021b", "name": "Natalie Portman"},
            {"id": "ef1e2ad4-df4f-4fe0-8fa9-b8db690c4a19", "name": "Christopher Lee"},
        ],
        "writers": [
            {"id": "8c220eeb-8022-44d5-8435-1f8edf258ac7", "name": "Jonathan Hales"},
            {"id": "a5a8f573-3cee-4ccc-8a2b-91cb9f55250a", "name": "George Lucas"},
        ],
    },
    {
